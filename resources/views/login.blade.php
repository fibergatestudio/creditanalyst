                    ...
                    <form method="POST" action="{{ route('login.custom') }}">
                        ...
                        <form class="card-form">
                            <div class="form-group row">
                                <label for="login" class="col">@lang('login.Логин:')</label>
                                <input type="email" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }} col-md-7" id="login" placeholder="">
                                <span class="col"></span>
                            ...
                            <div class="form-group row">
                                ...
                                <input type="password" class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }} col-md-7" id="exampleInputPassword1" placeholder="">
                                <span class="col"></span>
                            </div>
