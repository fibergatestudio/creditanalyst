...
<section id="page-list-users" class="section-content">
        <div class="content-title">
            <h2 class="name-menu">@lang('user_management.Администрирование')</h2>
        ...
        <div class="card card-fluid">
            <div class="card-body">
                <h3 class="title-block">@lang('user_management.Кабинет администратора')</h3>
                <div class="content-title">
                    <span>@lang('user_management.Список пользователей')</span>
                    <a href="{{ url('/admin_user_management/create_user') }}" class="done-new-user"><i class="fas fa-plus"></i> @lang('user_management.Добавить нового пользователя')</a></div>
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th>E-mail:</th>
                            <th>@lang('user_management.Имя:')</th>
                            <th>@lang('user_management.Фамилия:')</th>
                            <th>@lang('user_management.Статус:')</th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
